...
def participantes_evento(request, id):
    ...
    if request.method == "GET":
        participantes = evento.participantes.all()[::3] # '[::3]' utiizado para apresentar do id descrito em diante
...
def gerar_certificado(request, id):
    ...
    for participante in evento.participantes.all():
        # TODO: Validar se já existe certificado desse participante para esse evento parecido com alinha "108"
